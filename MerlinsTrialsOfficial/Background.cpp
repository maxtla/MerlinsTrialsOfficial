...
{
	HRESULT hr = p2DEngine->getDeviceContextPtr()->CreateSolidColorBrush(D2D1::ColorF(D2D1::ColorF::Black, 0.0f), &m_basicBrush);
	if (FAILED(hr))
	...
	m_bitmapBrush->SetTransform(D2D1::Matrix3x2F::Scale(D2D1::SizeF(m_rectF.right/1920, m_rectF.bottom/1080), D2D1::Point2F(m_rectF.left, m_rectF.top)));
}
