...
enum HOLDING { YES, NO };
enum PUZZLE_PHASE { FIRST, SECOND, END };
enum CURRENT_LEVEL { ONE, TWO, THREE };
enum TIMER { START, STOP, INACTIVE };


#define DEGTORAD(degree) ((3.14159265359f / 180.0f) * (degree)) // converts from degrees to radians
#define RADTODEG(radian) ((180.0f / 3.14159265359f) * (radian)) // converts from radians to degrees
