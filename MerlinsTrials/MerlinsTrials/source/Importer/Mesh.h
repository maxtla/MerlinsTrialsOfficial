...
public:
	...
	void createBoundingShapeFromType(int type, float scaling = 1.0f);
	...
	void DrawDebugMode(BasicShader * pDebugShader,
		PrimitiveBatch<VertexPositionColor> *debugBatch, Matrix view, Matrix proj, Vector4 color);
	...
	bool collisionTestFrustrum(BoundingFrustum *frustrum);
};
