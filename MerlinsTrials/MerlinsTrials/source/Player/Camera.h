...
public:
	...
	void setFOV(float fov) { m_fov = fov; this->m_projection = DirectX::XMMatrixPerspectiveFovRH(m_fov, m_aspect, m_nearZ, m_farZ); }
	void setAspectRatio(float aspect) { m_aspect = aspect; this->m_projection = DirectX::XMMatrixPerspectiveFovRH(m_fov, m_aspect, m_nearZ, m_farZ); }
	void setNearZ(float nearZ) { m_nearZ = nearZ; this->m_projection = DirectX::XMMatrixPerspectiveFovRH(m_fov, m_aspect, m_nearZ, m_farZ); }
	void setFarZ(float farZ) { m_farZ = farZ; this->m_projection = DirectX::XMMatrixPerspectiveFovRH(m_fov, m_aspect, m_nearZ, m_farZ); }
	void setOrthoViewWidth(float viewWidth) { m_viewWidth = viewWidth;  this->m_orthoProj = DirectX::XMMatrixOrthographicRH(m_viewWidth, m_viewHeight, m_orthoNearZ, m_orthoFarZ); }
	void setOrthoViewHeight(float viewHeight) { m_viewHeight = viewHeight; this->m_orthoProj = DirectX::XMMatrixOrthographicRH(m_viewWidth, m_viewHeight, m_orthoNearZ, m_orthoFarZ); }
	void setOrthoNearZ(float nearZ) { m_orthoNearZ = nearZ; this->m_orthoProj = DirectX::XMMatrixOrthographicRH(m_viewWidth, m_viewHeight, m_orthoNearZ, m_orthoFarZ); }
	void setOrthoFarZ(float farZ) { m_orthoFarZ = farZ; this->m_orthoProj = DirectX::XMMatrixOrthographicRH(m_viewWidth, m_viewHeight, m_orthoNearZ, m_orthoFarZ); }
