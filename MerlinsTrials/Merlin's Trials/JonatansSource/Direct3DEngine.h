...
protected:
	...
	Microsoft::WRL::ComPtr<ID3D11Texture2D> m_pBackBuffer; //backbuffer
	Microsoft::WRL::ComPtr<ID3D11DepthStencilView> m_pDSV;
	Microsoft::WRL::ComPtr<ID3D11Texture2D> m_pDB; //depth buffer
	...
	Microsoft::WRL::ComPtr<ID3D11RasterizerState> m_pRS; //raster state
